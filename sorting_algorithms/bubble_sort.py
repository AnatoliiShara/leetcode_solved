...
Pass 1:
    ...
    First iteration (i = 0, j = 0): Compare 7 and 5. Since 7 is greater than 5, a swap occurs. The array becomes arr = [5, 7, -8, 0, 10, 1].
    Second iteration (i = 0, j = 1): Compare 7 and -8. Since 7 is greater than -8, a swap occurs. The array becomes arr = [5, -8, 7, 0, 10, 1].
    Third iteration (i = 0, j = 2): Compare 7 and 0. Since 7 is greater than 0, a swap occurs. The array becomes arr = [5, -8, 0, 7, 10, 1].
    Fourth iteration (i = 0, j = 3): Compare 7 and 10. Since 7 is not greater than 10, no swap occurs.
    Fifth iteration (i = 0, j = 4): Compare 10 and 1. Since 10 is greater than 1, a swap occurs. The array becomes arr = [5, -8, 0, 7, 1, 10].

List after Pass 1: [5, -8, 0, 7, 1, 10]

Pass 2:

    First iteration (i = 1, j = 0): Compare 5 and -8. Since 5 is greater than -8, a swap occurs. The array becomes arr = [-8, 5, 0, 7, 1, 10].
    Second iteration (i = 1, j = 1): Compare 5 and 0. Since 5 is greater than 0, a swap occurs. The array becomes arr = [-8, 0, 5, 7, 1, 10].
    Third iteration (i = 1, j = 2): Compare 7 and 1. Since 7 is greater than 1, a swap occurs. The array becomes arr = [-8, 0, 5, 1, 7, 10].
...
Pass 3:
    ...
    Third iteration (i = 2, j = 2): Compare 5 and 1. Since 5 is greater than 1, a swap occurs. The array becomes arr = [-8, 0, 1, 5, 7, 10].
...
I appreciate your attention to detail, and I apologize for any confusion earlier.
"""
